...
var (
	srcFile = flag.String("swagger-file", "openapi/api.swagger.json", "Swagger file path")
	dstFile = flag.String("openapiv3-file", "openapi/api.yaml", "destination OpenAPI v3 file path")
)
